...
class NuScenes:
    ...
    def obtain_points(self,
        ...
        if sensor_modality in ['lidar', 'radar']:
            ...
            #     for box in boxes:
            #         c = 255
            #         corners = box.render(ax, view=np.eye(4), colors=(c, c, c))
            #         print(corners.shape)
        return points
...
class NuScenesExplorer:
    ...
    def render_sample_data(self,
        ...
        return points
            ...
            # scatter = ax.scatter(points[0, :], points[1, :], c='w', s=point_scale)
        ...
        # #         for box in boxes:
        # #             c = np.array(self.get_color(box.name)) / 255.0
        # #             box.rende(ax, view=camera_intrinsic, normalize=True, colors=(c, c, c))
        # #
        # #     # Limit visible range.
        ...
        # ax.set_aspect('equal')
        # if out_path is not None:
        #     plt.savefig(out_path, bbox_inches = 'tight', facecolor='black', pad_inches=0.0, dpi = 100)
        # plt.close()
